...
# Virtual Try-On Prompts
VTON_PROMPT_CN = """上装（仅上衣）服装提取提示词（中文）
...
上装类型包括但不限于：T 恤、衬衫、上衣、针织衫、毛衣、连帽衫、卫衣。

删除并移除所有下装与外套。

包括但不限于：

裤子、牛仔裤、短裤、裙子、半身裙、外套、夹克、西装外套、连衣裙、连体服。

仅保留上装本体，不包含腰带或任何穿戴附属物。
...
如检测到人体、下装、外套或配饰残留，必须继续删除，仅保留上装核心服装。
