...
# Virtual Try-On Prompts
VTON_PROMPT_CN = """
上装（仅上衣）提取专用提示词（QwenImage Edit 优化）
...
上装包括但不限于：
T 恤、衬衫、女衬衫、上衣、毛衣、连帽衫、卫衣、夹克、西装外套、大衣。

彻底删除所有下装及非上装服饰。

包括但不限于：
裤子、长裤、牛仔裤、短裤、裙子、紧身裤、连衣裙、连体服。

不包含任何配饰、叠穿单品或穿戴附属物。

上装必须以无人体支撑的形式展示（悬浮或平铺）。

颜色必须与输入图像 100% 完全一致。

不允许任何颜色变化、色相偏移、饱和度变化或亮度变化。

必须保留原始面料纹理、材质、缝线和图案细节。

背景必须为纯白色。

如检测到任何人体、下装或配饰残留，必须继续删除，仅保留核心上装。
