...
下装类型包括但不限于：裤子、牛仔裤、短裤、裙子、半身裙。

删除并移除所有上装与外套。

包括但不限于：

上衣、T 恤、衬衫、毛衣、针织衫、外套、夹克、西装外套、连衣裙、连体服。

仅保留下装本体，不包含腰带或任何穿戴附属物。

下装必须以无人体支撑的形式展示（悬浮或平铺）。
...
如检测到人体、上装、外套或配饰残留，必须继续删除，仅保留下装核心服装。""",

    "upper": """执行图像编辑操作：删除并移除人物、人体区域、配饰及非目标服装。
...
如检测到任何人体、配饰或非目标服装残留，必须继续删除，仅保留单一最大面积服装。""",

    "dress": """执行图像编辑操作：删除并移除人物及配饰。
将人物、人体区域以及所有配饰完全擦除、清空、不可见。
